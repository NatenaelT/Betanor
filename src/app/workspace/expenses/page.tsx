...
export default async function ExpensesPage() {
  const supabase = await createClient();
  const { workspaceId, userId, permissions } = await resolveWorkspace(supabase);
  const canRequest = permissions.has("expense.request") || permissions.has("finance.create");
