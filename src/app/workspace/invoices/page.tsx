...
export default async function InvoicesPage() {
  ...
  const canCreate = permissions.has("finance.create");
  const canApprove = permissions.has("finance.approve");
