...
export default async function AdminUsersPage() {
  ...
  return <main className="mx-auto max-w-7xl px-6 py-10 lg:px-8">
    <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end"><div><p className="text-sm font-semibold tracking-[0.14em] text-[var(--betanor-blue)] uppercase">Administration</p><h1 className="mt-3 text-3xl font-semibold tracking-tight text-[var(--betanor-navy)]">Users & access</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-[var(--betanor-muted)]">Control staff roles, employee onboarding, and customer portal access without exposing Supabase Auth administration to the browser.</p></div><div className="flex flex-wrap items-center gap-3"><Link href="/workspace/employees" className="rounded-lg bg-[var(--betanor-navy)] px-4 py-2.5 text-sm font-semibold text-white">Create employee</Link><Badge tone="info">Super admin protected</Badge></div></div>
