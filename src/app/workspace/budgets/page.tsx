...
export default async function BudgetsPage() {
  const supabase = await createClient();
  const { workspaceId, permissions } = await resolveWorkspace(supabase);
