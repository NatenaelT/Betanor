...
export function WorkspaceSidebar() {
  ...
  return <>
    ...
    <aside className="hidden h-screen max-h-screen w-72 shrink-0 overflow-y-auto border-r border-slate-800 bg-[var(--betanor-dark-navy)] px-5 py-6 text-slate-300 lg:sticky lg:top-0 lg:block"><NavigationContents /></aside>
