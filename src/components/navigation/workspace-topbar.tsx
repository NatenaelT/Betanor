...
export function WorkspaceTopbar({ email, displayName, avatarUrl }: { email: string; displayName?: string | null; avatarUrl?: string | null }) {
  ...
  return <header className="sticky top-0 z-20 flex min-h-16 items-center gap-3 border-b border-[var(--betanor-border)] bg-[var(--betanor-header-bg)]/95 px-5 pl-18 text-[var(--betanor-header-text)] backdrop-blur lg:px-8 lg:pl-8 print:hidden">
