  ...
  return (
    <header className="relative border-b border-[var(--betanor-border)] bg-white shadow-[0_1px_0_rgba(18,53,107,0.03)]">
      <nav className="mx-auto flex min-h-20 max-w-7xl items-center justify-between gap-6 px-6 lg:px-8" aria-label="Primary navigation">
        ...
        <div className="hidden items-center gap-2 sm:gap-3 lg:flex"><Link className="rounded-lg border border-[var(--betanor-border)] px-3 py-2 text-sm font-semibold text-[var(--betanor-navy)] transition-colors hover:border-[var(--betanor-blue)] hover:text-[var(--betanor-blue)] sm:px-4" href="/customer/login">Sign in / Sign up</Link></div>
