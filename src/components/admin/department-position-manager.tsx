...
export function DepartmentPositionManager() {
  ...
  return <div className="mt-8 space-y-5">
    <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end"><div><h2 className="text-xl font-semibold text-[var(--betanor-navy)]">Departments & departmental positions</h2><p className="mt-1 max-w-3xl text-sm leading-6 text-[var(--betanor-muted)]">Positions are conditional on a department. Leave the code blank and Supabase generates a stable DEPT-### or DEPTCODE-P### identifier.</p></div><div className="flex items-center gap-2"><Button size="sm" onClick={() => setDepartmentModalOpen(true)}>New department</Button><Badge tone="info">HR / admin protected</Badge></div></div>
